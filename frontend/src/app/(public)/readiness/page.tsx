  ...
  return (
    <div className="flex-1 w-full max-w-[1200px] mx-auto px-6 py-12 font-sans select-none">
      <div className="flex items-center gap-2 mb-6">
        ...
        <span className="text-text-primary text-xs font-semibold uppercase tracking-wider">Readiness Quiz</span>
      </div>
      ...
      <Card className="p-8 border-l-4 border-l-accent-teal space-y-6">
        ...
        <div className="space-y-2">
          ...
          <p className="text-xs text-text-secondary leading-relaxed max-w-[600px]">
            Evaluate your household emergency preparedness levels and calculate your official readiness scores. Complete system mapping is scheduled in a future step.
          </p>
        </div>
