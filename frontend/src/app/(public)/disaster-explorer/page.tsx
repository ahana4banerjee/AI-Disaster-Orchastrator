...
export default function DisasterExplorerPlaceholder() {
  return (
      ...
      <Card className="p-8 border-l-4 border-l-accent-primary space-y-6">
        ...
        <div className="space-y-2">
          ...
          <p className="text-xs text-text-secondary leading-relaxed max-w-[600px]">
            Explore historical records and query nearby geographic locations. Complete system mapping is scheduled in a future step.
          </p>
        </div>
