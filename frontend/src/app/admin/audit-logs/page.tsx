    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-slate-400 text-sm mt-1">
          Strict trace history recording modifications, simulations executed, and PDF export activities.
        </p>
      </div>
      ...
      <div className="bg-slate-900/40 border border-slate-800/80 rounded-2xl p-8 text-center text-slate-400 flex flex-col items-center justify-center min-h-[300px]">
        ...
        <h3 className="text-white font-bold text-lg mb-1">Administrative Audit Logs</h3>
        <p className="text-sm max-w-sm mb-6">
          Review operator events, updates to historical database collections, temporal runs started, and exported sitreps mapping specific administrators to timestamps.
        </p>
